...
function Chocolate() {
 ...
 function moveRight(){
  ...
  return (
    ...
    <div className="chocolate-bg-image">
      <div className="navbar">
      <img src={Logo} alt="couldnt load" className="chocolate-logo"/>
      ...
      <h1 className="chocolate-above-big">TREAT YO SELF</h1>
      <h1 className="chocolate-big-text">CHOCOLATE <br/>
          DELIGHT!</h1>
      <button className="chocolate-big-button">SHOP NOW</button>
      
    </div>
    <img src={HotChocolate} className="hot-chocolate"/>
    <div className="right">
    <h2 className="right-text"><span style={{color: "white", fontWeight:"bolder"}}>01</span>/04</h2>
